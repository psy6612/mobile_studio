...
/*            val mActivity = activity as MainActivity
            //mActivity.set`(coinFragment(),selectedList)
            val result = "result"
            ...
            mActivity.setDataFragment(coinFragment(),data)*/
            ...
            /*           for (item in selectedList) {
                ...
                var url_price = "https://api.upbit.com/v1/ticker?markets="
                val request = Request.Builder().url(url_price).build()
                    ...
                    override fun onResponse(call: Call, response: Response) {
                        ...
                        try {
                            ...
                            while (i < coinInfo.length()) {
                                ...
                                // println(coin_list[i].kor_name)
                                if (arr[0] == "KRW") {
                                    //select.add(CoinData(korean_name, arr[1], arr[1], arr[0]))
                                } else if (arr[0] == "BTC") {
                                    //select.add(CoinData(korean_name, arr[1], arr[1], arr[0]))
                                }
                                if (arr[0] != "USDT") {
